...
<svelte:head>
	...
	<meta
		name="description"
		content="3 column preview card component  tailwindcss, unocss, svelte solution by inurhuda00 for FrontendMentor.io" />
	<meta name="keywords" content="Frontend Mentor, Homepage Component Challenge, inurhuda00" />
	<meta property="og:title" content="3 column preview card component tailwindcss, unocss, svelte | Frontend Mentor" />
	<meta
	...
	<div class="flex justify-center items-center bg-#F2F2F2 max-w-xs rounded-lg lg:max-w-57.5rem">
		<section class="grid lg:flex">
			<div class="bg-#FF8C00 rounded-t-lg lg:rounded-none lg:rounded-l-lg p-12 lg:min-w-[19.2rem]">
				...
				<Button color="text-#FF8C00" />
			</div>
			<div class=" bg-#007C86 p-12 lg:min-w-[19.2rem]">
				<svg width="64" height="40" xmlns="http://www.w3.org/2000/svg" class="mb-8 lg:mb-10">
					<g fill="none" fill-rule="evenodd">
						<circle fill="#000" opacity=".201" cx="20" cy="20" r="20" /><path
